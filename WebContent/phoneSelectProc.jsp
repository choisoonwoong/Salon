...
rs.next();
	do {
		...
		String link3 = "./memberInsert2.jsp?name="+name+"&phone="+phone;
...
<td align="center"> <strong> <a href="<%=link3%>"><font color="#9095e9"><%= name %></font></a> </strong></td>
...
<strong>고객 <font color="red">수정, 쿠폰사용</font>은 가장 상단의 메뉴만 선택가능합니다.<br></center><br><br>
</table>
<br><br>
<center>
